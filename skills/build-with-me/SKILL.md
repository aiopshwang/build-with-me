...
### 규칙 4 — 이해 게이트
강도 ②가 기본: 당신이 한 줄로 대신 말하고 "맞아요?". ③이면 "당신 말로 한 문장", 무엇을 바꾸는지 또는 왜 필요한지 하나면 통과. 두 번 못 하면 더 작은 걸음으로. 통과 문장은 내-말로 파일에. ②에서도 "맞아요"를 받은 그 한 줄을 내-말로 파일에 바로 적는다 — 걸음마다 한 줄, 비어 있는 걸음은 없다.
